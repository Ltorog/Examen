...
function regression(req, res) {
    ...
    gender , rut, apiKey 
    FROM (SELECT ROUND(AVG(finished_courses.grade),2)  AS promedio, round(coalesce(stddev_samp(finished_courses.grade),0),3) AS stddev, courses.year AS year, students.first_name AS firstName, students.last_name AS lastName,
    ...
    group by courses.year, students.first_name, students.last_name, students.gender, students.rut, students.birthdate, tokens.apiKey) AS dato
